...
import { initDrillSession, handleDrillKeydown } from './drill.js?v=66';
import { loadProgress, setWordStatus, getWordStatus, getWordStats } from './storage.js?v=66';
import { translations } from './i18n.js?v=66';
import { loginUser, signUpUser, getCurrentUser } from './auth.js?v=66';
