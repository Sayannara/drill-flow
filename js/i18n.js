export const translations = {
    fr: {
        ...
        subtitle_home_remaining_selection: "Il vous reste {remaining} mots à valider (dont {selected} dans la sélection).",
    ...
    en: {
        ...
        subtitle_home_remaining_selection: "You have {remaining} words remaining to validate ({selected} in selection).",
    ...
    de: {
        ...
        subtitle_home_remaining_selection: "Sie müssen noch {remaining} Wörter lernen ({selected} in der Auswahl).",
    ...
    es: {
        ...
        subtitle_home_remaining_selection: "Le quedan {remaining} palabras por validar ({selected} en la selección).",
