export const translations = {
    fr: {
        ...
        milestone_giraffe_tooltip: "Cap des {count} mots validés atteint ! Viens voir ta progression !",
        ...
        btn_reactivate_ignored: "Réactiver les ignorés",
        confirm_reactivate_ignored: "Réactiver les {count} mot(s) ignoré(s) affiché(s) ? Ils redeviendront actifs dans vos sessions de drill.",
        tooltip_reactivate_word: "Cliquer pour réactiver ce mot",
        ...
        stat_cefr_overall: "Progression globale CECRL",
        stat_cefr_tier_progress: "Avancement vers {level} :",
        stat_cefr_tier_badge: "Palier {level}",
        ...
        cert_learned_words: "Total mots validés",
        cert_total_points: "Total points",
        cert_attested_volume: "• Bilan certifié : total de {words} mots validés ({points} points au total).",
        ...
        test_intro_subtitle: "Niveaux A1 à C2 • {words} mots / palier • Objectif : {threshold}% • ~{minutes} min max",
        ...
        test_click_level_tip: "Cliquez sur un niveau pour voir vos réponses et le détail des mots",
        test_row_click_hint: "Cliquer pour voir le détail des mots de ce niveau",
        test_detail_header: "Mots testés au palier",
        test_your_answer: "Votre réponse :",
        test_no_answer: "Non répondu",
        test_no_word_details: "Aucun détail disponible pour ce niveau.",
        test_timeout_short: "Temps écoulé",
        test_skipped_short: "Passé",

        
        // About View
        title_about: "Le Projet",
        ...
        about_note_subjectivity: "Les traductions sont souvent subjectives : même avec l'IA, c'est un vrai casse-tête que de faire l'exercice pour plus de 8 000 mots.",
        about_note_gender: "Dans la plupart des cas, les formes féminines ont été ajoutées afin d'accepter aussi bien le masculin que le féminin lors de vos réponses.",
        ...
        options_lang_title: "Langues d'apprentissage",
        ...
        options_accents_title: "Accents & Majuscules",
        options_accents_desc: "Tolérer les réponses sans accents ni majuscules (ex: 'january' pour 'January', 'ss' pour 'ß'). En mode strict, la casse exacte et les accents sont obligatoires.",
        options_accents_on: "Tolérance active",
        options_accents_off: "Stricte",
        spelling_hint: "Orthographe exacte : {word}",
        keys_toggle_hide: "Masquer les caractères spéciaux",
        keys_toggle_show: "Afficher les caractères spéciaux",
    ...
    en: {
        ...
        milestone_giraffe_tooltip: "Milestone of {count} validated words reached! Check out your progress!",
        ...
        btn_reactivate_ignored: "Reactivate ignored",
        confirm_reactivate_ignored: "Reactivate the {count} displayed ignored word(s)? They will become active again in your drill sessions.",
        tooltip_reactivate_word: "Click to reactivate this word",
        ...
        stat_cefr_overall: "Overall CEFR Progress",
        stat_cefr_tier_progress: "Progress towards {level}:",
        stat_cefr_tier_badge: "Milestone {level}",
        ...
        cert_learned_words: "Total Validated Words",
        cert_total_points: "Total Points",
        cert_attested_volume: "• Certified volume: total of {words} validated words ({points} total points).",
        ...
        // Placement Test
        btn_placement_test: "Assess my level (A1 to C2 Test)",
        test_intro_title: "Adaptive Placement Test",
        test_intro_subtitle: "Levels A1 to C2 • {words} words / level • Target: {threshold}% • ~{minutes} min max",
        test_intro_desc: "This test assesses your actual vocabulary through successive levels from A1 to C2.",
        
        // About View
        title_about: "The Project",
        ...
        about_note_subjectivity: "Translations are often subjective: even with AI, curating and refining over 8,000 words is a real puzzle.",
        about_note_gender: "In most cases, feminine forms have been added so both masculine and feminine answers are accepted.",
        ...
        nav_options: "Options",
        options_modal_title: "Options",
        options_lang_title: "Learning languages",
        ...
        options_accents_title: "Accents & Capitalization",
        options_accents_desc: "Accept answers without accents or capital letters (e.g. 'january' for 'January', 'ss' for 'ß'). In strict mode, exact case and accents are required.",
        options_accents_on: "Tolerant",
        options_accents_off: "Strict",
        spelling_hint: "Exact spelling: {word}",
        keys_toggle_hide: "Hide special letters",
        keys_toggle_show: "Show special letters",
    ...
    de: {
        ...
        milestone_giraffe_tooltip: "Meilenstein von {count} gelernten Wörtern erreicht! Schau dir deinen Fortschritt an!",
        ...
        btn_reactivate_ignored: "Ignorierte reaktivieren",
        confirm_reactivate_ignored: "Die {count} angezeigten ignorierten Wörter reaktivieren? Sie werden wieder aktiv in Ihren Drill-Sitzungen.",
        tooltip_reactivate_word: "Klicken, um dieses Wort zu reaktivieren",
        ...
        stat_cefr_overall: "Gesamter GER-Fortschritt",
        stat_cefr_tier_progress: "Fortschritt zu {level}:",
        stat_cefr_tier_badge: "Stufe {level}",
        ...
        cert_learned_words: "Validierte Wörter (gesamt)",
        cert_total_points: "Gesamtpunkte",
        cert_attested_volume: "• Bescheinigtes Volumen: insgesamt {words} validierte Wörter ({points} Punkte gesamt).",
        ...
        // Einstufungstest
        btn_placement_test: "Mein Sprachniveau testen (A1 bis C2)",
        test_intro_title: "Adaptiver Einstufungstest",
        test_intro_subtitle: "Stufen A1 bis C2 • {words} Wörter / Stufe • Ziel: {threshold}% • ~{minutes} Min. max.",
        test_intro_desc: "Dieser Test bewertet Ihren realen Wortschatz in aufeinanderfolgenden Stufen von A1 bis C2.",
        
        // About View
        title_about: "Das Projekt",
        ...
        about_note_subjectivity: "Übersetzungen sind oft subjektiv: Selbst mit KI ist die Feinabstimmung von über 8.000 Wörtern eine echte Denksportaufgabe.",
        about_note_gender: "In den meisten Fällen wurden weibliche Formen ergänzt, sodass sowohl männliche als auch weibliche Antworten akzeptiert werden.",
        ...
        options_lang_title: "Lernsprachen",
        ...
        options_accents_title: "Akzente & Großschreibung",
        options_accents_desc: "Antworten ohne Akzente oder Großbuchstaben akzeptieren (z. B. 'january' für 'January', 'ss' für 'ß'). Im strikten Modus sind exakte Groß-/Kleinschreibung und Akzente erforderlich.",
        options_accents_on: "Tolerant",
        options_accents_off: "Strikt",
        spelling_hint: "Exakte Schreibweise: {word}",
        keys_toggle_hide: "Sonderzeichen ausblenden",
        keys_toggle_show: "Sonderzeichen einblenden",
    ...
    es: {
        ...
        milestone_giraffe_tooltip: "¡Hito de {count} palabras validadas alcanzado! ¡Mira tu progreso!",
        ...
        btn_reactivate_ignored: "Reactivar ignoradas",
        confirm_reactivate_ignored: "¿Reactivar las {count} palabra(s) ignorada(s) mostrada(s)? Volverán a estar activas en tus sesiones de drill.",
        tooltip_reactivate_word: "Haz clic para reactivar esta palabra",
        ...
        stat_cefr_overall: "Progresión general MCER",
        stat_cefr_tier_progress: "Progreso hacia {level}:",
        stat_cefr_tier_badge: "Hito {level}",
        ...
        cert_learned_words: "Total palabras validadas",
        cert_total_points: "Total de puntos",
        cert_attested_volume: "• Volumen certificado: total de {words} palabras validadas ({points} puntos en total).",
        ...
        // Test de Nivel
        btn_placement_test: "Evaluar mi nivel (Test A1 a C2)",
        test_intro_title: "Test de Nivel Adaptativo",
        test_intro_subtitle: "Niveles A1 a C2 • {words} palabras / nivel • Objetivo: {threshold}% • ~{minutes} min máx.",
        test_intro_desc: "Esta prueba evalúa tu vocabulario real en niveles sucesivos de A1 a C2.",
        
        // About View
        title_about: "El Proyecto",
        ...
        about_note_subjectivity: "Las traducciones son a menudo subjetivas: incluso con la IA, afinar más de 8.000 palabras es un verdadero rompecabezas.",
        about_note_gender: "En la mayoría de los casos, se han añadido las formas femeninas para aceptar tanto el masculino como el femenino en sus respuestas.",
        ...
        options_lang_title: "Idiomas de aprendizaje",
        ...
        options_accents_title: "Acentos y Mayúsculas",
        options_accents_desc: "Aceptar respuestas sin acentos ni mayúsculas (ej: 'january' por 'January', 'ss' por 'ß'). En modo estricto, se exigen la mayúscula exacta y los acentos.",
        options_accents_on: "Tolerante",
        options_accents_off: "Estricta",
        spelling_hint: "Ortografía exacta: {word}",
        keys_toggle_hide: "Ocultar letras especiales",
        keys_toggle_show: "Mostrar letras especiales",
